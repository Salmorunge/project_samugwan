# Generated by Django 2.0.2 on 2018-03-04 05:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefer_1st', models.CharField(choices=[('BAI', '감사원'), ('MOEL', '고용노동부'), ('KFTC', '공정거래위원회'), ('MSIT', '과학기술정보통신부'), ('KCS', '관세청'), ('MOE', '교육부'), ('MPVA', '국가보훈처'), ('NHRC', '국가인권위원회'), ('OPC', '국무총리실'), ('MND', '국방부'), ('NTS', '국세청'), ('MOLIT', '국토교통부'), ('FSC', '금융위원회'), ('MOSF', '기획재정부'), ('MAFRA', '농림축산식품부'), ('CHA', '문화재청'), ('MCST', '문화체육관광부'), ('KCC', '방송통신위원회'), ('DAPA', '방위사업청'), ('MOLEG', '법제처'), ('MMA', '병무청'), ('MOHW', '보건복지부'), ('KFS', '산림청'), ('MOTIE', '산업통상자원부'), ('SDIA', '새만금개발청'), ('MFDS', '식품의약품안전처'), ('MOGEF', '여성가족부'), ('MPM', '인사혁신처'), ('PPS', '조달청'), ('MSS', '중소벤처기업부'), ('NEC', '중앙선거관리위원회'), ('KOSTAT', '통계청'), ('MOU', '통일부'), ('KIPO', '특허청'), ('MOF', '해양수산부'), ('MOIS', '행정안전부'), ('NAACC', '행정중심복합도시건설청'), ('ME', '환경부')], default='', max_length=20)),
                ('prefer_2nd', models.CharField(choices=[('BAI', '감사원'), ('MOEL', '고용노동부'), ('KFTC', '공정거래위원회'), ('MSIT', '과학기술정보통신부'), ('KCS', '관세청'), ('MOE', '교육부'), ('MPVA', '국가보훈처'), ('NHRC', '국가인권위원회'), ('OPC', '국무총리실'), ('MND', '국방부'), ('NTS', '국세청'), ('MOLIT', '국토교통부'), ('FSC', '금융위원회'), ('MOSF', '기획재정부'), ('MAFRA', '농림축산식품부'), ('CHA', '문화재청'), ('MCST', '문화체육관광부'), ('KCC', '방송통신위원회'), ('DAPA', '방위사업청'), ('MOLEG', '법제처'), ('MMA', '병무청'), ('MOHW', '보건복지부'), ('KFS', '산림청'), ('MOTIE', '산업통상자원부'), ('SDIA', '새만금개발청'), ('MFDS', '식품의약품안전처'), ('MOGEF', '여성가족부'), ('MPM', '인사혁신처'), ('PPS', '조달청'), ('MSS', '중소벤처기업부'), ('NEC', '중앙선거관리위원회'), ('KOSTAT', '통계청'), ('MOU', '통일부'), ('KIPO', '특허청'), ('MOF', '해양수산부'), ('MOIS', '행정안전부'), ('NAACC', '행정중심복합도시건설청'), ('ME', '환경부')], default='', max_length=20)),
                ('prefer_3rd', models.CharField(choices=[('BAI', '감사원'), ('MOEL', '고용노동부'), ('KFTC', '공정거래위원회'), ('MSIT', '과학기술정보통신부'), ('KCS', '관세청'), ('MOE', '교육부'), ('MPVA', '국가보훈처'), ('NHRC', '국가인권위원회'), ('OPC', '국무총리실'), ('MND', '국방부'), ('NTS', '국세청'), ('MOLIT', '국토교통부'), ('FSC', '금융위원회'), ('MOSF', '기획재정부'), ('MAFRA', '농림축산식품부'), ('CHA', '문화재청'), ('MCST', '문화체육관광부'), ('KCC', '방송통신위원회'), ('DAPA', '방위사업청'), ('MOLEG', '법제처'), ('MMA', '병무청'), ('MOHW', '보건복지부'), ('KFS', '산림청'), ('MOTIE', '산업통상자원부'), ('SDIA', '새만금개발청'), ('MFDS', '식품의약품안전처'), ('MOGEF', '여성가족부'), ('MPM', '인사혁신처'), ('PPS', '조달청'), ('MSS', '중소벤처기업부'), ('NEC', '중앙선거관리위원회'), ('KOSTAT', '통계청'), ('MOU', '통일부'), ('KIPO', '특허청'), ('MOF', '해양수산부'), ('MOIS', '행정안전부'), ('NAACC', '행정중심복합도시건설청'), ('ME', '환경부')], default='', max_length=20)),
